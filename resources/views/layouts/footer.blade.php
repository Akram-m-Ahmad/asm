    ...
    <div class="container-fluid">
        <div class="row">
            <nav class="footer-nav">
                <ul>
                    <li>
                        <a href="" target="_blank">{{ __('Akram ') }}</a>
                    </li>
                    <!-- <li>
            ...
            <div class="credits ml-auto">
                <span class="copyright">
                    ...
                    </script>{{ __(', made with ') }}<i class="fa fa-heart heart"></i>{{ __(' by ') }}<a class="@if(Auth::guest()) text-white @endif" href="" target="_blank">{{ __('Akram') }}</a>        </span>
            </div>
        </div>
    </div>
</footer>