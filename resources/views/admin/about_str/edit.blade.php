...
@section('content')
    <div class="content">
        <div class="card">
            ...
            @endif
            <form class="col-md-12" action="{{ route('about_str.update', $about_str->id) }}" method="POST"
                ...
                <div class="card-body">
                    <div class="form-row text-right">
                        <div class="form-group col-md-12">
                            ...
                            <input placeholder="title" type="text" name="title" value="{{ $about_str->title }}" class="form-control">

                        </div>
                        <div class="form-group col-md-12">
                            <label>{{ __('المعلومات') }}</label>
                            <input placeholder="details" type="text" name="details" value="{{ $about_str->details }}" class="form-control">
