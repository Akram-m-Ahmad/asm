...
@section('content')
    <div class="content">
        <div class="card">
            ...
            @endif
            <form class="col-md-12" action="{{ route('domains.update', $domain->id) }}" method="POST"
                ...
                <div class="card-body">
                    <div class="form-row text-right">
                        <div class="form-group col-md-12">
                            ...
                            <input placeholder="title" type="text" name="title" value="{{ $domain->title }}" class="form-control">

                        </div>
                        <div class="form-group col-md-12">
                            <label>{{ __('المعلومات') }}</label>
                            <input placeholder="details" type="text" name="details" value="{{ $domain->details }}" class="form-control">
