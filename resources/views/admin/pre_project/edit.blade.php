...
@section('content')
    <div class="content">
        <div class="card">
            ...
            @endif
            <form class="col-md-12" action="{{ route('pre_project.update', $pre_projects->id) }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-md-12">
                            ...
                            <input placeholder="title" type="text" name="title" value="{{ $pre_projects->title }}" class="form-control">

                        </div>
                        <div class="form-group col-md-12">
                            <label>{{ __(' المعلومات    ') }}</label>
                            <input   value="{{ $pre_projects->details }}" type="text"
