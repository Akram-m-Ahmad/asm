...
@section('content')
    <div class="content">
        <div class="card">
            ...
            @endif
            <form class="col-md-12" action="{{ route('teams.update', $teams->id) }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-md-12">
                            ...
                            <input placeholder="title" type="text" name="name" value="{{ $teams->name }}" class="form-control">

                        </div>
                    <div class="form-group col-md-12">
                            <label>{{ __('  العنوان   ') }}</label>
                            <input placeholder="title" type="text" name="title" value="{{ $teams->title }}" class="form-control">

                        </div>
                        <div class="form-group col-md-12">
                            <label>{{ __(' المعلومات    ') }}</label>
                            <input   value="{{ $teams->details }}" type="text"
                                name="details" class="form-control">
                        </div>
                        <div class="form-group col-md-12">
                            <label>{{ __(' فيسبوك    ') }}</label>
                            <input   value="{{ $teams->f_link }}" type="text"
                                name="f_link" class="form-control">
                        </div>
