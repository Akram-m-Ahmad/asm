    ...
    <div class="content">
        ...
        <div class="card">
            <div class="pull-right" style="padding-left:10px">
                <a class="btn btn-success" href="{{ route('statistics.create') }}"> إضافة </a>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($statistics as $statistics)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('statistics.destroy', $statistics->id) }}" method="POST">
                                            <a class="btn btn-info btn-icon  "
                                                href="{{ route('statistics.show', $statistics->id) }}"> <i
                                                    class="fa fa-eye"></i></a>

                                            <a class="btn btn-primary btn-icon"
                                                href="{{ route('statistics.edit', $statistics->id) }}"><i
