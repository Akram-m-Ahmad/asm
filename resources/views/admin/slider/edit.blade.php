...
@section('content')
    <div class="content">
        <div class="card">
            ...
            @endif
            <form class="col-md-12" action="{{ route('slider.update', $sliders->id) }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-md-12">
                            ...
                            <input placeholder="title" type="text" name="title" value="{{ $sliders->title }}" class="form-control">

                        </div>
                        <div class="form-group col-md-12">
                            <label>{{ __(' المعلومات    ') }}</label>
                            <input   value="{{ $sliders->details }}" type="text"
