        ...
        <div class="card">
            <div class="card-header">
                <div class="pull-right">
                    <h5 class="title">{{ __('أضف  جديدة') }}</h5>
                </div>
                <div class="pull-left">
            ...
            <form class="col-md-12" action="{{ route('activities.store') }}" method="POST"
                ...
                <div class="card-body">
                    <div class="form-row text-right">
                        <div class="form-group col-md-12">
                            ...
                            <input placeholder="title" type="text" name="name" class="form-control">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input placeholder="details" type="date" name="date" class="form-control">
